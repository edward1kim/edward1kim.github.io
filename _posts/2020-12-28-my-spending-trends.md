...
date: 2020-12-28
share: false
permalink: /life/my-spending-trends
categories:
    - Life
---
...
![total spend per month](/assets/images/spending-charts/monthly-spend.jpg){:width="800px"}  
...
{:refdef: style="text-align: center;"}
![eating out vs groceries](/assets/images/spending-charts/eating-out-vs-groceries.jpg){:width="800px"}  
...
{:refdef: style="text-align: center;"}
![total spend percentages](/assets/images/spending-charts/spend-split.jpg){:width="600px"}  
<sup>***Spend split in percentages (minus investments)***</sup>
{: refdef}

{:refdef: style="text-align: center;"}
![total spend minus rent percentages](/assets/images/spending-charts/spend-split-minus-rent.jpg){:width="600px"}  
